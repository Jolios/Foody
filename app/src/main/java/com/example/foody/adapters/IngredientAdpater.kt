...
class IngredientAdpater : RecyclerView.Adapter<IngredientAdpater.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.binding.ingredientImageView.load(Constants.BASE_IMAGE_URL + ingredientsList[position].image){
            crossfade(600)
